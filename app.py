...
db_phase_1 = {
        ...
        "marlin": "[A éviter] Certains produits de la mer ne sont pas autorisés.",
        "requin": "[A éviter] Certains produits de la mer ne sont pas autorisés.",
        "espadon": "[A éviter] Certains produits de la mer ne sont pas autorisés.",
        "thon": "[A éviter] Certains produits de la mer ne sont pas autorisés.",
        "lait": "[A éviter] Les produits laitiers sont pas autorisés.",
        "fromage": "[A éviter] Les produits laitiers sont pas autorisés.",
		"chou-fleur": "[A éviter] Certains légumes ne sont pas autorisés dans le régime semi-restreint.",
		"maïs": "[A éviter] Certains légumes ne sont pas autorisés dans le régime semi-restreint.",
		"ail": "[A éviter] Certains légumes ne sont pas autorisés dans le régime semi-restreint.",
		"champignons": "[A éviter] Certains légumes ne sont pas autorisés dans le régime semi-restreint.",
		"oignons": "[A éviter] Certains légumes ne sont pas autorisés dans le régime semi-restreint.",
